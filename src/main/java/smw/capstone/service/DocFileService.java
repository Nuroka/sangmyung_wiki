...
public class DocFileService {
    ...
    public void updateDocFile(ReqUpdateDocDTO reqUpdateDocDTO, List<String> updateFiles) {
        ...
        Documents updateDoc = docRepository.findByIdAndMember(reqUpdateDocDTO.getDocId(), temp).orElseThrow(() -> new BusinessException(CustomErrorCode.NOT_EXIST_MEMBER_DOC)); //null예외처리
